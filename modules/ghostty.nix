...
}:
{
  flake.modules.homeManager.ghostty =
    { pkgs, ... }:
    {
      xdg.configFile."ghostty/themes/yui_dark".text = builtins.readFile "${
        inputs.yui.packages.${pkgs.stdenv.hostPlatform.system}.ghostty
      }/ghostty/yui_dark";

      xdg.configFile."ghostty/themes/yui_light".text = builtins.readFile "${
        inputs.yui.packages.${pkgs.stdenv.hostPlatform.system}.ghostty
      }/ghostty/yui_light";
